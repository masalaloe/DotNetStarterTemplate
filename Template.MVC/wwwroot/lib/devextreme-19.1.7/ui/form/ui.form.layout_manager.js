...
var LayoutManager = _ui4.default.inherit({
    ...
    _updateItems: function(layoutData) {
        var items, processedItems, that = this,
            ...
            isUserItemsExist = (0, _type.isDefined)(userItems),
    ...
    _renderFieldItem: function(item, $container) {
        var $label, that = this,
            ...
            isRequired = (0, _type.isDefined)(item.isRequired) ? item.isRequired : !!that._hasRequiredRuleInSet(item.validationRules),
    ...
    linkEditorToDataField: function(editorInstance, dataField) {
        ...
        editorInstance.on("valueChanged", function(args) {
            if (!((0, _type.isObject)(args.value) && args.value === args.previousValue)) {
                _this3._updateFieldValue(dataField, args.value)
            }
        })
    },
